...
export function WebmToMp4() {
  ...
  return (
    <div className="rounded-xl border bg-card p-5 sm:p-6">
      <BatchUploadZone accept="video/webm" onFilesSelect={addFiles} label="Drop WebM files to convert to MP4" />
      ...
      <p className="mt-3 text-xs text-muted-foreground">
        ...
        runs entirely in your browser via WebAssembly, no upload. Files process one at a time, in
        order.
      </p>
    </div>
  );
