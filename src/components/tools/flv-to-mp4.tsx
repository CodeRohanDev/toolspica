...
export function FlvToMp4() {
  ...
  return (
    <div className="rounded-xl border bg-card p-5 sm:p-6">
      <MediaUploadZone file={file} onFileSelect={setFile} onClear={() => setFile(null)} accept="video/x-flv,.flv" kind="video" />
      ...
      <p className="mt-2 text-xs text-muted-foreground">
        FLV (Flash Video) is essentially obsolete now that Flash is discontinued — this converts an
        old FLV file to standard H.264/AAC MP4, playable everywhere.
      </p>
    </div>
  );
}
